...
// @updateURL    https://raw.githubusercontent.com/lyonlui/addon/main/appointment-tools-dev.user.js
// @require      https://cdn.bootcss.com/blueimp-md5/2.10.0/js/md5.min.js
// @downloadURL  https://raw.githubusercontent.com/lyonlui/addon/main/appointment-tools-dev.user.js
...
function Reserve(WID,vcode) {
    ...
    xmlhttp.onreadystatechange=function()
    {
        if (xmlhttp.readyState==4 && xmlhttp.status==200)
        {
            ...
            if(responseJson.msg.indexOf("验证码错误") != -1){        //验证码错误
                getCaptcha(WID);
                return;
            }
            if(responseJson.msg.indexOf("多") != -1){       //人太多，重试
                getCaptcha(WID);
                return;
            }
