...
function timeOut(WID){
    ...
    console.log("开始抢讲座");
    myInterval = setInterval(Reserve,800,WID);
...
function autoAppointment(listJsonObj){
    ...
    for (var i=0;i<listJsonObj.totalSize;i++)
    {
        ...
        if(yes){
            ...
            setTimeout(timeOut,yykssjUnixTime-currentUnixTime-10000, WID);      //设置预约开始时间提前10s开始抢讲座
            ...
            mindSpan.textContent = '倒计时中... 请勿刷新和关闭窗口';
